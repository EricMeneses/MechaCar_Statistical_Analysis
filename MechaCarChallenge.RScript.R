...
library(tidyverse)
mecha_mpg <- read.csv(file='~/Desktop/Data/Classwork/Week_15/Challenge_15/Resources/MechaCar_mpg.csv',check.names=F,stringsAsFactors = F) 
...
mecha_coil <- read.csv(file='~/Desktop/Data/Classwork/Week_15/Challenge_15/Resources/Suspension_Coil.csv',check.names=F,stringsAsFactors = F) 
